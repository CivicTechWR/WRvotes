---
title: Information About Media Sources
layout: page-toc
---
...
- We are a manually-curated site, and only link to things we know
  about. If we are missing something relevant, please contact us. 
- We attempt to distinguish between opinions and factual news items,
  but this is a fuzzy area and we may not always get it right. 
...
We are looking for evidence of independence and accountability.

Some sites we consider to be established news sites include:

- CTV Kitchener
- Global News Kitchener
- CBC Kitchener-Waterloo
- Waterloo Region Record and other Metroland properties (New Hamburg
  Independent, Waterloo Chronicle, Cambridge Times)

## All-Candidates Meetings and Debates

We link to most recordings of all-candidates meetings and debates,
regardless of who produces them. The rules of thumb for being
considered an all-candidates meeting are: 

- Were all candidates for a particular position invited to the
  meeting?
- Are the candidates asked to respond to rounds of questions?
...
We do not link to every opinion piece about the municipal election. 
We reserve the right to refrain from linking to any particular media
item. 
...
Many news outlets produce profiles of candidates running in local
races. We link to many of these, even though multiple profiles of the
same candidate are often very similar. 

Sometimes candidate profiles resemble questionnaires in the sense that
all candidates are asked identical questions. Usually if each
candidate is presented in an individual article, we classify these as
candidate profiles. Otherwise we use our discretion.


## Objectionable Links

Elections get heated, and some users of our site may find the contents
of media we link to objectionable. Our goal in this website is to help
voters make more informed decisions about the municipal election, and
sometimes that information is unpleasant to read. As a reminder: we do
not endorse the position of any media we link to, and as a nonpartisan
website we do not endorse candidates.

If you are thinking of suing us for
defamation, you should be aware of Canadian case law: in particular
the [Crookes vs
Newton](https://www.canlii.org/en/ca/scc/doc/2011/2011scc47/2011scc47.html)
Supreme Court decision from 2011. This ruling asserts that in most
cases linking to a defamatory source on the Internet is itself not
defamatory. 

Here are some background articles about this decision: 

+ [Liability for hyperlinking after the Supreme Court of Canada’s
  Decision of Crookes v.
  Newton](https://canliiconnects.org/en/commentaries/28687) . 
+ [Are Hyperlinks
