---
title: Housing in Waterloo Region
layout: page-toc
---
...
Housing is one of the most direct ways municipal government shapes daily life.
Local councils make decisions about **zoning**, **development approvals**, and
...
housing for low-income residents. This includes managing thousands of units
directly and overseeing wait-lists that have historically stretched to a decade
or more.
...
Some municipalities (for example
[Kitchener](https://kitchenerhousinginc.ca/){:target="_blank"}) also
own and manage some social housing.
